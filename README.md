...
TaskPyro 是一个轻量级、功能丰富、稳定的 Python 任务调度平台，专注于提供简单易用的任务管理、爬虫调度解决方案和 AI 智能助手功能。它能够帮助您轻松管理和调度 Python 任务，特别适合需要定时执行的爬虫任务、数据处理任务，以及通过 AI 智能交互进行系统管理的场景。专业版独有"流程编排"功能，实现 Python 脚本零 API 封装化，让您的 Python 脚本秒变 HTTP 接口，无缝接入 n8n/Dify/Coze 等低代码生态，打造"脚本即服务"的轻量级 Serverless 函数计算平台"+"低代码集成网关。

> 官网文档：https://docs.taskpyro.cn/

![登录界面](https://pic1.imgdb.cn/item/69c7c9ee4066a6014cf59c8b.png)
...
- 🔄 **集成开发者**：需要将 Python 能力快速接入 n8n/Dify/Coze 等低代码平台
...
-  ⚡ **流程编排**（创新）
  - **脚本即服务**：Python 脚本零 API 封装化，直接暴露为 HTTP 接口
  - **低代码集成**：无缝接入 n8n、Dify、Coze 等低代码/AI 编排生态
  - **可视化编排**：拖拽式画布构建复杂工作流，数据管道化流转
  - **外部触发**：生成 HTTP Hook 地址，支持 cURL 一键调用
  - **环境隔离**：内部虚拟环境隔离，调用方无需关心 Python 环境
...
![专业版仪表盘-性能指标界面](https://pic1.imgdb.cn/item/69c751b1ebec5f1015553c17.png)

### 任务统计分析
通过直观的图表展示任务执行情况，包括成功率、失败原因分析、平均执行时间等统计数据，助您全面了解任务运行状况。

![专业版仪表盘-任务统计界面](https://pic1.imgdb.cn/item/69c7c9c64066a6014cf59c7b.png)

### 工作节点状态
实时监控所有工作节点的运行状态、资源使用情况和连接状态，确保分布式系统的稳定运行。

![专业版仪表盘-工作节点界面](https://pic1.imgdb.cn/item/69c751b1ebec5f1015553c15.png)


### 任务日历视图
通过日历形式直观展示任务分布情况，不同颜色代表不同任务状态，方便您快速识别任务执行模式。

![专业版仪表盘-日历图界面](https://pic1.imgdb.cn/item/69c751beebec5f1015553c1f.png)

### 任务详情查看
点击日历中的具体日期，可查看该天所有任务的详细执行情况，包括开始时间、结束时间、执行状态等信息。

![专业版仪表盘-点击查看一整天任务详细界面](https://pic1.imgdb.cn/item/69c751bfebec5f1015553c20.png)


### 甘特图
展示24内定时任务的耗时分布，方便查看或对比每天不同任务耗时分布

![专业版仪表盘-甘特图任务耗时详细分布界面](https://pic1.imgdb.cn/item/69c7c9d14066a6014cf59c80.png)
...
![AI 助手对话界面](https://pic1.imgdb.cn/item/69c7ca044066a6014cf59c9a.png)

### AI 对话模式选择
支持多种对话模式，满足不同需求：对话模式（日常对话交互，快速响应）、思考模式（深度分析问题，展示推理过程）、文档模式（基于系统文档提供准确答案）。

![AI 对话模式选择](https://pic1.imgdb.cn/item/69c7ca054066a6014cf59c9b.png)

### AI 配置管理
灵活配置多个大模型 API，支持 DeepSeek、智谱清言等主流模型，满足不同场景需求。

![AI 配置界面](https://pic1.imgdb.cn/item/69c7ca024066a6014cf59c98.png)

### AI 机器人配置
将 AI 助手集成到主流即时通讯平台，支持飞书、钉钉、企业微信，随时随地与系统交互。

![AI 机器人配置界面](https://pic1.imgdb.cn/item/69c7ca034066a6014cf59c99.png)

### 飞书机器人对话
在飞书群聊中与 AI 助手对话，查询系统信息、管理任务、接收告警通知。

![飞书机器人对话场景](https://pic1.imgdb.cn/item/69c7ca084066a6014cf59c9d.png)

### 钉钉机器人对话
在钉钉群聊中与 AI 助手对话，随时随地监控系统状态和管理任务。

![钉钉机器人对话场景](https://pic1.imgdb.cn/item/69c7ca184066a6014cf59ca5.png)

### 企业微信机器人对话
在企业微信群聊中与 AI 助手对话，通过移动办公提高工作效率。

![企业微信机器人对话场景](https://pic1.imgdb.cn/item/69c7ca174066a6014cf59ca4.png)
...
![专业版项目界面](https://pic1.imgdb.cn/item/69c751b1ebec5f1015553c16.png)

### ZIP项目创建
支持通过上传ZIP压缩包快速创建项目，系统会自动解压并部署到指定节点，简化项目部署流程。

![新建ZIP项目界面](https://pic1.imgdb.cn/item/69c7c9c64066a6014cf59c77.png)

### GIT项目集成
支持通过Git仓库地址创建项目，自动拉取代码并部署，支持私有仓库认证，实现代码与任务平台的无缝集成。

![新建GIT项目界面](https://pic1.imgdb.cn/item/69c7c9c64066a6014cf59c79.png)

### 在线代码编辑
提供功能强大的在线代码编辑器，让您无需本地IDE即可进行代码修改和调试。

![代码在线编辑界面](https://pic1.imgdb.cn/item/69c751bfebec5f1015553c21.png)
...
![添加Python版本界面](https://pic1.imgdb.cn/item/69c7c9ed4066a6014cf59c89.png)
...
![专业版环境管理界面](https://pic1.imgdb.cn/item/69c751c0ebec5f1015553c23.png)

### 环境快速创建
支持一键创建虚拟环境，可选择Python版本和预安装的依赖包，大幅简化环境配置流程，提高开发效率。

![环境创建](https://pic1.imgdb.cn/item/69c7c9c64066a6014cf59c7a.png)

### 安装过程日志
提供详细的包安装日志，实时展示安装进度和可能出现的错误信息，帮助您快速定位和解决环境配置问题。

![安装日志](https://pic1.imgdb.cn/item/69c7c9f84066a6014cf59c92.png)

### 智能镜像源配置
内置多个常用PyPI镜像源，自动选择最快的源进行包安装，支持自定义镜像源，加速依赖包的安装过程。

![智能镜像源管理](https://pic1.imgdb.cn/item/69c7c9ee4066a6014cf59c8c.png)
...
![专业版新建任务界面](https://pic1.imgdb.cn/item/69c7c9c64066a6014cf59c78.png)

### 任务列表管理
集中展示所有任务的状态、调度规则和最近执行情况，支持按状态、节点等条件筛选，提供批量操作功能，方便您高效管理大量任务。

![任务列表界面](https://pic1.imgdb.cn/item/69c751bfebec5f1015553c22.png)

### 执行历史记录
详细记录每个任务的历史执行情况，包括开始时间、结束时间、执行状态和耗时，帮助您分析任务执行模式和性能瓶颈。

![执行历史界面](https://pic1.imgdb.cn/item/69c7c9f64066a6014cf59c8f.png)

### 运行日志查看
提供实时的任务运行日志，支持在线查看和下载，方便您监控任务执行过程和排查问题，提高故障诊断效率。

![运行日志界面](https://pic1.imgdb.cn/item/69c7c9f94066a6014cf59c94.png)
...
![节点界面](https://pic1.imgdb.cn/item/69c751b1ebec5f1015553c14.png)

### 节点添加配置
支持快速添加新的工作节点，配置节点名称、地址和认证信息，系统会自动检测节点连接状态，确保节点正常接入集群。

![添加节点](https://pic1.imgdb.cn/item/69c7c9d14066a6014cf59c7f.png)

### 微服务节点管理
TaskPyro支持微服务架构，可将不同功能部署到专用节点，提高系统可扩展性和容错能力，满足大规模分布式部署需求。

![TaskPyro微服务节点界面](https://pic1.imgdb.cn/item/69c7c9d14066a6014cf59c83.png)

### 节点性能监控
实时监控各节点的CPU、内存、磁盘使用率等性能指标，支持历史数据查询和趋势分析，帮助您及时发现并解决性能问题。

![节点监控](https://pic1.imgdb.cn/item/69c751b1ebec5f1015553c15.png)
...
![日志管理界面](https://pic1.imgdb.cn/item/69c7c9f94066a6014cf59c93.png)
...
![用户设置界面](https://pic1.imgdb.cn/item/69c7c9d14066a6014cf59c82.png)

### 用户权限配置
提供精细化的权限控制功能，可为每个用户或用户组分配特定的操作权限，确保系统安全性和数据隔离性。

![用户设置界面](https://pic1.imgdb.cn/item/69c7c9f84066a6014cf59c90.png)

### 邮件通知配置
支持配置邮件服务器和通知规则，系统可在任务执行完成、出现异常等情况下自动发送邮件通知，确保您及时了解系统状态。

![邮件设置界面](https://pic1.imgdb.cn/item/69c7ca004066a6014cf59c97.png)

### 系统信息设置
提供系统基本信息配置，包括系统名称、Logo和界面主题等，支持自定义系统外观，打造专属的任务调度平台。

![信息设置界面](https://pic1.imgdb.cn/item/69c7ca1b4066a6014cf59ca7.png)
